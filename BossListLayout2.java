...
public class BossListLayout2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.zak),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 55), 1)), "반감 없음", "결정석 : 122,689");
        // 노말 자쿰
        Dfs = 40;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.zak),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 110), 1)), "전 속성 반감", "결정석 : 375,735");
        // 이지 파풀라투스
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pap),
                "\n 이지\n 파풀라투스\n ", " LV.125\n HP : 400,000,000\n (4억 / 본체 포함)", text_dpen,
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 125), 1)), "전 속성 반감", "결정석 : 419,901");
        // 이지 매그너스
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.mag),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 110), 1)), "전 속성 반감", "결정석 : 442,906");
        // 노말 힐라
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hil),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 110), 1)), "전 속성 반감", "결정석 : 490,757");
        // 이지 혼테일
        Dfs = 40;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "반감 없음", "결정석 : 541,059");
        // 반반
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.banb),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 120), 1)), "전 속성 반감", "결정석 : 593,814");
        // 피에르
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pie),
                "\n 피에르\n ", " LV.120\n HP : 315,000,000 (3억1500만)", text_dpen,
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 120), 1)),"전 속성 반감(특수)", "결정석 : 593,814");
        // 블러디 퀸
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.bel),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "전 속성 반감", "결정석 : 593,814");
        // 노말 혼테일
        Dfs = 40;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 160), 1)), "반감 없음", "결정석 : 621,112");
        // 이지 반레온
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 120), 1)), "반감 없음", "결정석 : 649,023");
        // 이지 아카이럼
        Dfs = 60;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.aca),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "반감 없음", "결정석 : 706,686");
        // 카웅
        Dfs = 60;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.car),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 180), 1)), "전 속성 반감", "결정석 : 766,805");
        // 카오스 혼테일
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 180), 1)), "반감 없음", "결정석 : 829,376");
        // 노말 핑크빈
        Dfs = 70;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pik),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 180), 1)), "번개 제외 반감", "결정석 : 861,582");
        // 노말 반레온
        Dfs = 80;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "반감 없음", "결정석 : 894,403");
        // 하드 반레온
        Dfs = 100;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 140), 1)), "반감 없음", "결정석 : 1,502,940");
        // 노말 아카이럼
        Dfs = 90;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.aca),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 170), 1)), "반감 없음", "결정석 : 1,546,188");
        // 노말 매그너스
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.mag),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "전 속성 반감", "결정석 : 1,590,047");
        // 노말 파풀라투스
        Dfs = 90;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pap),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 155), 1)), "전 속성 반감", "결정석 : 1,634,522");
    }
