...
public class BossListLayout2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.zak),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 164,141");
        // 노말 자쿰
        qkd = 40;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.zak),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 502,680");
        // 이지 파풀라투스
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pap),
                "\n 이지\n 파풀라투스\n ", " LV.125\n HP : 400,000,000\n (4억 / 본체 포함)", text_dpen,
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 561,771");
        // 이지 매그너스
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.mag),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 592,547");
        // 노말 힐라
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hil),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 656,564");
        // 이지 혼테일
        qkd = 40;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 723,861");
        // 반반
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.banb),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 764,441");
        // 피에르
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pie),
                "\n 피에르\n ", " LV.120\n HP : 315,000,000 (3억1500만)", text_dpen,
                text_perdmg, qus(qkd), qus(round(rhks, 1)),"전 속성 반감(특수)", "결정석 : 764,441");
        // 블러디 퀸
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 830,962");
        // 이지 반레온
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 868,303");
        // 이지 아카이럼
        qkd = 60;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.aca),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 945,450");
        // 카웅
        qkd = 60;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.car),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 1,025,880");
        // 카오스 혼테일
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 1,109,590");
        // 노말 핑크빈
        qkd = 70;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pik),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "번개 제외 반감", "결정석 : 1,152,677");
        // 노말 반레온
        qkd = 80;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 1,196,586");
        // 하드 반레온
        qkd = 100;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 2,010,723");
        // 노말 아카이럼
        qkd = 90;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.aca),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "반감 없음", "결정석 : 2,068,583");
        // 노말 매그너스
        qkd = 50;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.mag),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 2,127,264");
        // 노말 파풀라투스
        qkd = 90;
        rhks = defenseCalculator(qkd, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pap),
                ...
                text_perdmg, qus(qkd), qus(round(rhks, 1)), "전 속성 반감", "결정석 : 2,186,764");
    }
