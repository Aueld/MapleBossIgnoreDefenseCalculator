...
public class BossListLayout2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.zak),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 55), 1)), "반감 없음", "결정석 : 119,835");
        // 노말 자쿰
        Dfs = 40;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.zak),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 110), 1)), "전 속성 반감", "결정석 : 366,997");
        // 이지 파풀라투스
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pap),
                "\n 이지\n 파풀라투스\n ", " LV.125\n HP : 400,000,000\n (4억 / 본체 포함)", text_dpen,
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 125), 1)), "전 속성 반감", "결정석 : 410,135");
        // 이지 매그너스
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.mag),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 110), 1)), "전 속성 반감", "결정석 : 432,605");
        // 노말 힐라
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hil),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 110), 1)), "전 속성 반감", "결정석 : 479,343");
        // 이지 혼테일
        Dfs = 40;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "반감 없음", "결정석 : 528,474");
        // 반반
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.banb),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 120), 1)), "전 속성 반감", "결정석 : 580,003");
        // 피에르
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pie),
                "\n 피에르\n ", " LV.120\n HP : 315,000,000 (3억1500만)", text_dpen,
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 120), 1)),"전 속성 반감(특수)", "결정석 : 580,003");
        // 블러디 퀸
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.bel),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "전 속성 반감", "결정석 : 580,003");
        // 노말 혼테일
        Dfs = 40;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 160), 1)), "반감 없음", "결정석 : 606,666");
        // 이지 반레온
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 120), 1)), "반감 없음", "결정석 : 633,927");
        // 이지 아카이럼
        Dfs = 60;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.aca),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "반감 없음", "결정석 : 690,249");
        // 카웅
        Dfs = 60;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.car),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 180), 1)), "전 속성 반감", "결정석 : 748,970");
        // 카오스 혼테일
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.hon),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 180), 1)), "반감 없음", "결정석 : 810,086");
        // 노말 핑크빈
        Dfs = 70;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pik),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 180), 1)), "번개 제외 반감", "결정석 : 841,544");
        // 노말 반레온
        Dfs = 80;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "반감 없음", "결정석 : 873,601");
        // 하드 반레온
        Dfs = 100;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.leo),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 140), 1)), "반감 없음", "결정석 : 1,467,984");
        // 노말 아카이럼
        Dfs = 90;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.aca),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 170), 1)), "반감 없음", "결정석 : 1,510,227");
        // 노말 매그너스
        Dfs = 50;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.mag),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 130), 1)), "전 속성 반감", "결정석 : 1,553,066");
        // 노말 파풀라투스
        Dfs = 90;
        Ign = defenseCalculator(Dfs, seter);
        ...
        adapter.addItem(ContextCompat.getDrawable(this, R.drawable.pap),
                ...
                text_perdmg, doubleToString(Dfs), doubleToString(calc(levelDamageCal(Ign, 155), 1)), "전 속성 반감", "결정석 : 1,596,506");
    }
